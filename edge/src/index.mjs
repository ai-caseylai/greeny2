import{DurableObject as I}from"cloudflare:workers";var w=class extends I{esp32ws=null;dashboards=new Map;ledState=!1;lastTelemetryMs=0;tds=0;ec=0;ph=7;temp=25;constructor(e,t){super(e,t),e.storage.sql.exec(`CREATE TABLE IF NOT EXISTS telemetry_buffer (
